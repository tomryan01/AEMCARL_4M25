...
from envs.utils.action import ActionXY
...
class ORCA(Policy):
    ...
    def predict(self, state, lidar_image=None):
        ...
        if self.sim is None:
            ...
            # self.sim.addAgent(self_state.position, self_state.radius + 0.01 + self.safety_space,
            #                   self_state.v_pref, self_state.velocity, *params)
